...
public class IAPKey
{
    public const string PACK1 = "nice_dream_add10";
    public const string PACK2 = "nice_dream_add20";
    public const string PACK3 = "nice_dream_add30";
    public const string PACK4 = "nice_dream_add40";
    public const string PACK5 = "nice_dream_add50";
}
